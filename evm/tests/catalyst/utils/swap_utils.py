...
def payloadConstructor(
    ...
    _context=brownie.convert.to_bytes(0, type_str="bytes1"),
):
    return (
        _context
        + brownie.convert.to_bytes(_from, type_str="bytes32")
        + brownie.convert.to_bytes(_to, type_str="bytes32")
        + _who
        + brownie.convert.to_bytes(_U, type_str="bytes32")
        + brownie.convert.to_bytes(_assetIndex, type_str="bytes1")
        + brownie.convert.to_bytes(_minOut, type_str="bytes32")
        + brownie.convert.to_bytes(_escrowAmount, type_str="bytes32")
        + brownie.convert.to_bytes(_escrowToken, type_str="bytes32")
        + brownie.convert.to_bytes(0, type_str="bytes2")
    )
