...
from utils.deploy_utils import run_deploy_swappool_unsafe, run_amp_deploy_swappool, run_amp_finish_setup
...
def test_finish_setup(swapfactory, crosschaininterface, chainId, tokens, deployer, hacker, gov):
...
def test_fee_config(
    ...
    assert sp._poolFeeX64() == pool_fee_x64
