...
def test_local_swap(
    ...
    if swap_amount/(source_token.balanceOf(pool)-swap_amount) < 1e-02:
...
@given(swap_amount=strategy("uint256", max_value=10*10**18), min_out=strategy("uint256", max_value=10*10**18))
