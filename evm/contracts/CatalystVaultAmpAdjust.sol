 ...
 */
contract CatalystVaultAmpAdjust is CatalystVaultAmplified {
    ...
    // For other config options, see CatalystVaultAmplified.sol and CatalystVaultCommon.sol

    //-- Variables --//
    int256 public _targetAmplification;

    constructor(address factory_) CatalystVaultAmplified(factory_) {}
