mod test_volatile_send_asset_success_failure {
    ...
    fn test_send_asset_success() {
        ...
        test_env.execute_contract(
            ...
            &VolatileExecuteMsg::OnSendAssetSuccess {
                ...
                asset: mock.from_asset.get_asset_ref().to_string(),
        ...
        let queried_total_escrowed_balances = test_env.get_app()
            ...
            .query_wasm_smart::<TotalEscrowedAssetResponse>(
                mock.vault.clone(),
                &QueryMsg::TotalEscrowedAsset { asset: mock.from_asset.get_asset_ref().to_string() }
            ).unwrap();
    ...
    fn test_send_asset_success_event() {
        ...
        assert_eq!(
            event.attributes[5],
            Attribute::new("asset", mock.from_asset.get_asset_ref().to_string())
        );
        assert_eq!(
            event.attributes[6],
    ...
    fn test_send_asset_failure_invalid_params() {
        ...
        let response_result = test_env.execute_contract(
            ...
            &VolatileExecuteMsg::OnSendAssetFailure {
                ...
                u: mock.u,
                escrow_amount: mock.from_amount - mock.fee,
                asset: mock.vault_assets[mock.from_asset_idx+1].get_asset_ref().to_string(),   // ! Not the original asset
                block_number_mod: mock.block_number 
            },
            vec![],
            vec![]
