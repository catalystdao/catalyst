mod test_amplified_withdraw_even {
    ...
    use crate::{msg::AmplifiedExecuteMsg, tests::helpers::amplified_vault_contract_storage};
    ...
    fn test_withdraw_even_min_out() {
        ...
        assert!(matches!(
            ...
            if 
                err_out <= f64_to_uint128(expected_return[0] * 1.000001).unwrap() &&
                err_out >= f64_to_uint128(expected_return[0] * 0.999999).unwrap() &&
