...
pub const REMOTE_CHAIN_INTERFACE : &str = "remote_chain_interface_addr";
...
pub const GENERALISED_INCENTIVES : &str = "generalised_incentives_addr";
pub const MESSAGING_AUTH         : &str = "messaging_auth_addr";
pub const LOST_GAS               : &str = "lost_gas_addr";

pub const VAULT_TOKEN_DENOM      : &str = "CAT";

pub const CHANNEL_ID             : Bytes32 = Bytes32([1; 32]);
pub const MESSAGE_ID             : Bytes32 = Bytes32([5; 32]);